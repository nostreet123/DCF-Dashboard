...
For data analysis, visualization, and basic operations, use **pandas** which provides powerful data manipulation capabilities:```python
import pandas as pd
...
### ❌ WRONG - Hardcoding Calculated Values```python
...
### ✅ CORRECT - Using Excel Formulas```python
...
### Creating new Excel files```python
...
### Editing existing Excel files```python
...
Excel files created or modified by openpyxl contain formulas as strings but not calculated values. Use the provided `recalc.py` script to recalculate formulas:```bash
...
The script returns JSON with error details:```json
{
