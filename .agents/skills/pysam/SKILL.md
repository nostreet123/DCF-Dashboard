...
**Query reference sequence:**```python
...
**Exception:** Region strings in `fetch()` follow samtools convention (1-based):```python
...
Pysam provides access to samtools and bcftools commands:```python
# Sort BAM file
