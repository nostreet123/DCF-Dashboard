...
- Includes Codex CLI attribution in commit message
...
This plugin is included in the Codex CLI repository. The commands are automatically available when using Codex CLI.
