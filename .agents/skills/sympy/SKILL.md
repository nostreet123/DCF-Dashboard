...
**Creating symbols and expressions:**```python
...
**Simplification and manipulation:**```python
...
**Algebraic equations:**```python
from sympy import solveset, solve, Eq
solveset(x**2 - 4, x)  # {-2, 2}
solve(Eq(x**2, 4), x)  # [-2, 2]
```

**Systems of equations:**```python
from sympy import linsolve, nonlinsolve
linsolve([x + y - 2, x - y], x, y)  # {(1, 1)} (linear)
nonlinsolve([x**2 + y - 2, x + y**2 - 3], x, y)  # (nonlinear)
```

**Differential equations:**```python
...
**Matrix creation and operations:**```python
...
**Eigenvalues and eigenvectors:**```python
...
**Convert to executable functions:**```python
...
**Generate C/Fortran code:**```python
...
### 1. Always Define Symbols First```python
from sympy import symbols
x, y, z = symbols('x y z')
# Now x, y, z can be used in expressions
```

### 2. Use Assumptions for Better Simplification```python
...
### 4. Numerical Evaluation When Needed```python
...
### 5. Convert to NumPy for Performance```python
...
### Pattern 1: Solve and Verify```python
...
### Pattern 2: Symbolic to Numeric Pipeline```python
...
### Pattern 3: Document Mathematical Results```python
...
## Quick Reference: Most Common Functions```python
# Symbols
from sympy import symbols, Symbol
x, y = symbols('x y')
...
### Example 1: Solve Quadratic Equation```python
...
### Example 2: Calculate Derivative```python
...
### Example 3: Evaluate Integral```python
...
### Example 4: Matrix Eigenvalues```python
...
### Example 5: Generate Python Function```python
from sympy import symbols, lambdify
import numpy as np
x = symbols('x')
expr = x**2 + 2*x + 1
