...
For most Vaex tasks, follow this pattern:```python
import vaex
...
### Pattern: Converting Large CSV to HDF5```python
import vaex
...
### Pattern: Efficient Aggregations```python
...
### Pattern: Virtual Columns for Feature Engineering```python
