...
All scvi-tools models follow a consistent API pattern:```python
...
Probabilistic DE analysis using the learned generative models:```python
...
Integrate datasets across batches or studies:```python
