...
**Cloud-agnostic:**
- Anthropic Codex (direct API)
- OpenAI (direct API)

**AWS ecosystem:**
- AWS Bedrock (Codex, Llama)
...
default_config.llm = "gpt-4o"  # Fast and capable
```
...
def get_agent_for_task(task_complexity):
    ...
    if task_complexity == 'simple':
        return A1(path='./data', llm='gpt-4o')
...
- Limited reasoning depth vs. Codex/GPT-4
