...
### Text extraction
If you just need to read the text contents of a presentation, you should convert the document to markdown:```bash
...
To create visual thumbnail grids of PowerPoint slides for quick analysis and reference:```bash
