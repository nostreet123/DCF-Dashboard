...
Load existing models from repositories or files:```python
...
Save models in various formats:```python
...
Access and inspect model components:```python
# Access components
...
Perform standard FBA simulation:```python
# Basic optimization
...
Parsimonious FBA (minimize total flux):```python
from cobra.flux_analysis import pfba
solution = pfba(model)
```

Geometric FBA (find central solution):```python
...
Determine flux ranges for all reactions:```python
...
Perform knockout analyses:```python
...
Sample the feasible flux space:```python
...
Calculate phenotype phase planes:```python
...
Add reactions to make models feasible:```python
...
Build models from scratch:```python
...
### Workflow 1: Load Model and Predict Growth```python
from cobra.io import load_model
...
### Workflow 2: Gene Knockout Screen```python
from cobra.io import load_model
...
### Workflow 3: Media Optimization```python
from cobra.io import load_model
from cobra.medium import minimal_medium
...
### Workflow 4: Flux Uncertainty Analysis```python
from cobra.io import load_model
from cobra.flux_analysis import flux_variability_analysis
from cobra.sampling import sample
...
Use context managers to make temporary modifications:```python
...
### DictList Objects
Models use `DictList` objects for reactions, metabolites, and genes - behaving like both lists and dictionaries:```python
# Access by index
...
Boolean logic linking genes to reactions:```python
