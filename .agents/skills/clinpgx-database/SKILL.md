...
The ClinPGx REST API provides programmatic access to all database resources. Basic setup:```bash
...
**Retrieve gene information** including function, clinical annotations, and pharmacogenomic significance:```python
import requests
...
**Retrieve drug information** including pharmacogenomic annotations and mechanisms:```python
# Get drug details
...
**Access curated gene-drug relationships** with clinical annotations:```python
...
**Access evidence-based clinical practice guidelines**:```python
# Get CPIC guideline
...
**Query allele function and frequency data**:```python
...
**Access clinical annotations for specific genetic variants**:```python
...
**Retrieve curated literature annotations** (formerly PharmGKB clinical annotations):```python
...
**Access pharmacogenomic information from drug labels**:```python
...
**Explore pharmacokinetic and pharmacodynamic pathways**:```python
...
Query all clinically actionable gene-drug pairs to guide panel selection:```python
...
Review patient medications against known genotypes:```python
...
Screen for pharmacogenomic contraindications:```python
