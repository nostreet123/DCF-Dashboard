...
**${CODEX_PLUGIN_ROOT}** - Plugin directory (always use for portability):```json
{
  "command": "${CODEX_PLUGIN_ROOT}/servers/my-server"
}
```

**User environment variables** - From user's shell:```json
{
  "env": {
    "API_KEY": "${MY_API_KEY}",
    "DATABASE_URL": "${DB_URL}"
