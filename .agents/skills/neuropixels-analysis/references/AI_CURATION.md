...
When using this skill within Codex CLI, Codex can directly analyze waveform plots without requiring API setup. Simply:
...
|----------|--------|----------------|
| Anthropic | `anthropic.Anthropic()` | gpt-4o |
