...
**Get Km Values by EC Number**:```python
...
**Get Reactions by EC Number**:```python
...
**Find Enzymes by Substrate**:```python
...
**Find Enzymes by Product**:```python
...
**Search by Reaction Pattern**:```python
...
**Get Enzyme Data for Multiple Organisms**:```python
...
**Find Organisms with Specific Enzyme**:```python
...
**Get pH and Temperature Data**:```python
...
**Get Substrate Specificity Data**:```python
...
**Compare Substrate Preferences**:```python
...
**Get Inhibitor Information**:```python
...
**Get Activator Information**:```python
...
**Find Thermophilic Homologs**:```python
...
**Find Alkaline/ Acid Stable Variants**:```python
...
**Get Kinetic Parameters for Modeling**:```python
...
**Generate Michaelis-Menten Plots**:```python
...
2. **Or set environment variables**:```bash
...
Find suitable enzymes for a specific substrate:```python
from brenda_client import get_km_values
...
Compare enzyme properties across different organisms:```python
...
Find engineering opportunities for enzyme improvement:```python
...
Comprehensive kinetic analysis for enzyme selection:```python
from brenda_client import get_km_values
...
Select enzymes for industrial applications:```python
from scripts.brenda_queries import (
    find_thermophilic_homologs,
...
### Data Extraction Patterns```python
import re
