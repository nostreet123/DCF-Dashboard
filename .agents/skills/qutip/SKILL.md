...
Optional packages for additional functionality:```bash
...
Create and manipulate quantum states and operators:```python
# States
...
Multiple solvers for different scenarios:```python
...
Compute physical quantities:```python
# Expectation values
...
Visualize quantum states and dynamics:```python
# Bloch sphere
b = Bloch()
b.add_states(psi)
b.show()
...
Specialized techniques for complex scenarios:```python
...
### Simulating a Damped Harmonic Oscillator```python
# System parameters
...
### Two-Qubit Entanglement Dynamics```python
# Create Bell state
psi0 = bell_state('00')
