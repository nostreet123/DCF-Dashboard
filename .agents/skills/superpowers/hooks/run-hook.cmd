...
@echo off
REM ============================================================================
REM DEPRECATED: This polyglot wrapper is no longer used as of Codex CLI 2.1.x
REM ============================================================================
REM
REM Codex CLI 2.1.x changed the Windows execution model for hooks:
REM
...
REM
REM   After (2.1.x):  Codex CLI now auto-detects .sh files in hook commands
...
REM
REM The fix: hooks.json now calls session-start.sh directly. Codex CLI 2.1.x
