...
Search for clinical trials using the helper script:```bash
cd scientific-databases/clinicaltrials-database/scripts
python3 query_clinicaltrials.py
```

Or use Python directly with the `requests` library:```python
import requests
...
Get detailed information about a trial using its NCT ID:```python
import requests
...
**Example: Find recruiting diabetes trials**```python
...
**Example: Find Phase 3 trials testing Pembrolizumab**```python
from scripts.query_clinicaltrials import search_studies
...
**Example: Find cancer trials in New York**```python
from scripts.query_clinicaltrials import search_studies
...
**Example: Find trials sponsored by NCI**```python
from scripts.query_clinicaltrials import search_studies
...
**Example: Find recently completed trials with results**```python
from scripts.query_clinicaltrials import search_studies
...
**Example: Extract eligibility criteria**```python
...
**Example: Extract contact information**```python
from scripts.query_clinicaltrials import get_study_details
...
**Example: Retrieve all matching trials**```python
...
**Example: Manual pagination with control**```python
from scripts.query_clinicaltrials import search_studies
...
**Example: Export to CSV file**```python
from scripts.query_clinicaltrials import search_studies
...
**Example: Create trial summary**```python
...
**Example: Multi-criteria search**```python
from scripts.query_clinicaltrials import search_studies
...
Run the script directly for example usage:```bash
...
3. Add delays between requests for large-scale data collection```python
import time
import requests
...
Always implement proper error handling for network requests:```python
import requests
...
Not all trials have complete information. Always check for field existence:```python
