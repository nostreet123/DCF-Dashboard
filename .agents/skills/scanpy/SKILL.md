...
The AnnData object is the core data structure in scanpy:```python
...
Identify and filter low-quality cells and genes:```python
...
**Use the QC script for automated analysis:**```bash
python scripts/qc_analysis.py input_file.h5ad --output filtered.h5ad
```

### 2. Normalization and Preprocessing```python
...
### 3. Dimensionality Reduction```python
# PCA
...
### 5. Marker Gene Identification```python
...
### Creating Publication-Quality Plots```python
...
### Differential Expression Between Conditions```python
...
Automated quality control script that calculates metrics, generates plots, and filters data:```bash
...
Complete analysis template providing a full workflow from data loading through cell type annotation. Copy and customize this template for new analyses:```bash
