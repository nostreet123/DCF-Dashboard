...
### Step 2: Compute SHAP Values```python
import shap
...
**For Global Understanding** (entire dataset):```python
...
**For Individual Predictions**:```python
...
**For Feature Relationships**:```python
...
### Pattern 1: Complete Model Analysis```python
# 1. Setup
explainer = shap.TreeExplainer(model)
shap_values = explainer(X_test)
...
### Pattern 2: Cohort Comparison```python
# Define cohorts
...
### Pattern 3: Debugging Errors```python
# Find errors
