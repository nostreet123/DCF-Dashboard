...
### Creating an AnnData object```python
...
Use backed mode or convert to sparse matrices:```python
# Backed mode
...
### Slow file reading
Use compression and appropriate formats:```python
...
Always align external data on index:```python
# Wrong
