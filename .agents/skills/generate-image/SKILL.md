...
Use the `scripts/generate_image.py` script to generate or edit images:```bash
...
### For Presentations and Posters```bash
...
### For General Visual Content```bash
