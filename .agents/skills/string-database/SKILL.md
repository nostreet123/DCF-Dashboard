...
**Use case**: Analyze a list of proteins from experiment (e.g., differential expression, proteomics).```python
...
**Use case**: Deep dive into one protein's interactions and partners.```python
...
**Use case**: Identify and visualize proteins in a specific biological pathway.```python
...
**Use case**: Compare protein interactions across different organisms.```python
from scripts.string_api import string_network
...
**Use case**: Start with seed proteins and discover connected functional modules.```python
