...
**By Chemical Name**:```python
import pubchempy as pcp
compounds = pcp.get_compounds('aspirin', 'name')
compound = compounds[0]
```

**By CID (Compound ID)**:```python
...
**Using PubChemPy (Recommended)**:```python
import pubchempy as pcp
...
**Get Specific Properties**:```python
...
**Batch Property Retrieval**:```python
import pandas as pd
...
Find structurally similar compounds using Tanimoto similarity:```python
import pubchempy as pcp
...
Find compounds containing a specific structural motif:```python
import pubchempy as pcp
...
Convert between different chemical structure formats:```python
import pubchempy as pcp
...
Generate 2D structure images:```python
import pubchempy as pcp
...
Get all known names and synonyms for a compound:```python
import pubchempy as pcp
...
Retrieve biological activity data from assays:```python
import requests
import json
...
Access detailed compound information through PUG-View:```python
import requests
...
Install PubChemPy for Python-based access:```bash
uv pip install pubchempy
```

For direct API access and bioactivity queries:```bash
uv pip install requests
```

Optional for data analysis:```bash
...
Convert between different chemical identifiers:```python
import pubchempy as pcp
...
Screen compounds using Lipinski's Rule of Five:```python
import pubchempy as pcp
...
Identify structurally similar compounds to a known drug:```python
import pubchempy as pcp
...
Compare properties across multiple compounds:```python
import pubchempy as pcp
import pandas as pd
...
Screen for compounds containing specific pharmacophores:```python
import pubchempy as pcp
