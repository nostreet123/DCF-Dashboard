...
**Basic environment structure:**```python
import numpy as np
...
### Training on Standard Benchmarks```python
# Atari
...
### Custom Task Development```python
...
### High-Performance Optimization```python
# Maximize throughput
env = pufferlib.make(
    'my-env',
