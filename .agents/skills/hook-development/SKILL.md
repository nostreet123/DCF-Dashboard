...
**Special capability:** Persist environment variables using `$CLAUDE_ENV_FILE`:```bash
...
**Pattern: Flag file activation**```bash
#!/bin/bash
...
**Pattern: Configuration-based activation**```bash
#!/bin/bash
...
- **Official Docs**: https://developers.openai.com/codex/rules
