...
Tests individual hook scripts with sample input before deploying to Codex CLI.
...
**Features:**
- Sets up proper environment variables (CLAUDE_PROJECT_DIR, CODEX_PLUGIN_ROOT)
