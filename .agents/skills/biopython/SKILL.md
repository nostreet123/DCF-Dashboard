...
Install Biopython using pip (requires Python 3 and NumPy):```python
uv pip install biopython
```

For NCBI database access, always set your email address (required by NCBI):```python
...
Example search patterns for reference files:```bash
...
### Pattern 1: Fetch Sequence from GenBank```python
...
### Pattern 2: Sequence Analysis Pipeline```python
from Bio import SeqIO
...
### Pattern 3: BLAST and Fetch Top Hits```python
from Bio.Blast import NCBIWWW, NCBIXML
from Bio import Entrez, SeqIO
...
### Pattern 4: Build Phylogenetic Tree from Sequences```python
...
To locate information in reference files, use these search patterns:```bash
