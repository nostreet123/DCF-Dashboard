...
**Use case**: Finding pathways associated with genes of interest (e.g., for pathway enrichment analysis).```python
...
**Use case**: Getting all genes in organism pathways for enrichment analysis.```python
...
**Use case**: Finding metabolic pathways containing compounds of interest.```python
from scripts.kegg_api import kegg_find, kegg_link, kegg_get
...
**Use case**: Integrating KEGG data with UniProt, NCBI, or PubChem databases.```python
...
**Use case**: Comparing pathways across different organisms.```python
