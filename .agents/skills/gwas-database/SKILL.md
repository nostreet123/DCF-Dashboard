...
**Example 1: Find all associations for a disease**```python
import requests
...
**Example 2: Get variant information and all trait associations**```python
import requests
...
**Example 3: Access summary statistics**```python
import requests
...
**Example 4: Query by chromosomal region**```python
import requests
...
**Example: Download summary statistics for a study**```python
import requests
import gzip
...
**Following Links in API Responses:**```python
import requests
...
Complete workflow for querying and analyzing GWAS data:```python
import requests
import pandas as pd
