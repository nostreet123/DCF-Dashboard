...
Comprehensive guidance on creating Codex CLI slash commands, including file format, frontmatter options, dynamic arguments, and best practices.
...
Codex CLI activates this skill when users:
...
6. Test examples work with current Codex CLI
