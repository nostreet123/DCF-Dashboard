...
### Scientific Literature Search```bash
...
Use `perplexity_search.py` as a module:```python
...
Create a script for multiple queries:```bash
#!/bin/bash
queries=(
