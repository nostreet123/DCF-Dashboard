...
| `llm_model` | str | `None` | Model name (e.g., "openai/gpt-4o") for image descriptions |
...
md = MarkItDown(
    llm_client=client,
    llm_model="openai/gpt-4o",  # recommended for scientific vision
...
- `openai/gpt-4o` - **Recommended for scientific vision**
- `openai/gpt-4o` - Advanced vision model
