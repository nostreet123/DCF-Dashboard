"""Seed data for dataset mappings and reference tables."""
...
SEED_DATASET_MAPPINGS = [
    ...
    *[
    ...
    {"pattern": regional_pattern("beta"), "datasetKey": "betas", "isRegex": True},
    {"pattern": regional_pattern("pe"), "datasetKey": "pedata", "isRegex": True},
    {"pattern": regional_pattern("pbv"), "datasetKey": "pbvdata", "isRegex": True},
    {"pattern": regional_pattern("ps"), "datasetKey": "psdata", "isRegex": True},
]
